...
describe('Payments API', () => {
    describe('POST /api/payments/initiate', () => {
        it('should initiate payment for a booking', async () => {
            ...
            const bookingResponse = await (0, supertest_1.default)(setup_1.app)
                .post('/api/bookings')
                .send({
    ...
    describe('POST /api/payments/callback', () => {
        it('should handle payment callback and update booking to confirmed', async () => {
            ...
            const bookingResponse = await (0, supertest_1.default)(setup_1.app)
                ...
                .expect(201);
            const bookingId = bookingResponse.body.data.booking.id;
            const paymentResponse = await (0, supertest_1.default)(setup_1.app)
                .post('/api/payments/initiate')
                .send({
                bookingId: bookingId.toString(),
                provider: 'telebirr'
            ...
            const callbackResponse = await (0, supertest_1.default)(setup_1.app)
